...
const OtherUserPage = ({ setPage, accountId }) => {
  ...
  const userPostsQuery = useQuery({
    ...
    queryFn: () => {
      ...
      return axios
        .get(`http://localhost:3001/post/${accountId}/posts`, config)
        .then((res) => {
  ...
  const query = useQuery({
    ...
    queryFn: () => {
      ...
      return axios
        .get(`http://localhost:3001/user/${accountId}`, config)
        .then((res) => {
          console.log(res.data);
          return res.data;
        })
  ...
  const friendsQuery = useQuery({
    ...
    queryFn: () => {
      ...
      return axios
        .get(`http://localhost:3001/user/${accountId}/friends`, config)
        .then((res) => {
          console.log(res.data);
          return res.data;
        })
